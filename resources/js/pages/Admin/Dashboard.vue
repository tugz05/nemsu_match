...
import { Users, MessageSquare, Heart, FileText, ArrowRight, Shield, ClipboardList } from 'lucide-vue-next';
...
<template>
    <div class="flex h-screen bg-gray-50 overflow-hidden">
        ...
        <AdminSidebar current-route="admin.dashboard" />

        <div class="flex-1 flex flex-col h-full overflow-y-auto bg-gradient-to-br from-slate-50 to-blue-50">
            
            <header class="bg-white border-b border-gray-200 shadow-sm flex-shrink-0 sticky top-0 z-10">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 w-full">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-gradient-to-br from-blue-600 to-cyan-500 rounded-xl flex items-center justify-center md:hidden">
                                <Shield class="w-6 h-6 text-white" />
                            </div>
                            <div class="md:hidden">
                                <h1 class="text-xl font-bold text-gray-900">Admin</h1>
                            </div>
                            <h1 class="hidden md:block text-xl font-bold text-gray-900">Dashboard Overview</h1>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                        ...
                        <div class="space-y-3">
                            ...
                            <Link
                                ...
                                class="flex items-center justify-between p-4 bg-gradient-to-r from-yellow-50 to-orange-50 hover:from-yellow-100 hover:to-orange-100 rounded-xl transition-colors group"
                            >
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-semibold text-gray-900 text-sm">Message Reports</p>
                                        <p class="text-xs text-gray-600">View analytics and logs</p>
                                    </div>
                                </div>
                                <ArrowRight class="w-5 h-5 text-gray-400 group-hover:text-yellow-600 transition-colors" />
                            </Link>

                            <Link
                                href="/admin/verifications"
                                class="flex items-center justify-between p-4 bg-gradient-to-r from-indigo-50 to-violet-50 hover:from-indigo-100 hover:to-violet-100 rounded-xl transition-colors group"
                            >
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-semibold text-gray-900 text-sm">Verifications</p>
                                        <p class="text-xs text-gray-600">Review user verifications</p>
                                    </div>
                                </div>
                                <ArrowRight class="w-5 h-5 text-gray-400 group-hover:text-indigo-600 transition-colors" />
                            </Link>
